  ...
  return (
    <>
      ...
      <div onClick={handleNavigation} className="cursor-pointer group relative z-10">
        ...
        ">
            <div className="image_container w-full h-[38.80%] rounded-lg relative overflow-hidden mt-[0.35rem] bg-gray-100">
            ...
            <div className="letters flex flex-col justify-between w-full flex-1 ">
                <div className="heading_and_author pr-0.5 w-full">
                  ...
                  <div className="author_name font-body font-medium text-xs text-autho group-hover:text-black/60 flex items-center justify-end transition-colors duration-75">
                        <div className="w-2 h-[2px] bg-authorname group-hover:bg-black/60 truncate"></div> 
                ...
                <div className="excr_extras flex flex-col gap-0.5">
                  ...
                  <div className="extras mt-auto w-full flex items-center justify-between pt-3 pb-0.5 border-t border-transparent relative min-h-[40px]">
