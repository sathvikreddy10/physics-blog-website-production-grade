        ...
        ">
            ...
            <div className="letters flex flex-col justify-between w-full flex-1 ">
                <div className="heading_and_author pr-0.5 w-full">
                  ...
                  <div className="author_name font-body font-medium text-xs text-[#a7a4a4] group-hover:text-black/60 flex items-center justify-end transition-colors duration-75">
